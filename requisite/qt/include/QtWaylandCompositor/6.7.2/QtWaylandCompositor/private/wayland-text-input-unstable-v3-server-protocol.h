...
zwp_text_input_v3_content_hint_is_valid(uint32_t value, uint32_t version) {
	switch (value) {
	case ZWP_TEXT_INPUT_V3_CONTENT_HINT_NONE:
		return version >= 1;
	case ZWP_TEXT_INPUT_V3_CONTENT_HINT_COMPLETION:
		return version >= 1;
	case ZWP_TEXT_INPUT_V3_CONTENT_HINT_SPELLCHECK:
		return version >= 1;
	case ZWP_TEXT_INPUT_V3_CONTENT_HINT_AUTO_CAPITALIZATION:
		return version >= 1;
	case ZWP_TEXT_INPUT_V3_CONTENT_HINT_LOWERCASE:
		return version >= 1;
	case ZWP_TEXT_INPUT_V3_CONTENT_HINT_UPPERCASE:
		return version >= 1;
	case ZWP_TEXT_INPUT_V3_CONTENT_HINT_TITLECASE:
		return version >= 1;
	case ZWP_TEXT_INPUT_V3_CONTENT_HINT_HIDDEN_TEXT:
		return version >= 1;
	case ZWP_TEXT_INPUT_V3_CONTENT_HINT_SENSITIVE_DATA:
		return version >= 1;
	case ZWP_TEXT_INPUT_V3_CONTENT_HINT_LATIN:
		return version >= 1;
	case ZWP_TEXT_INPUT_V3_CONTENT_HINT_MULTILINE:
		return version >= 1;
	default:
		return false;
	}
